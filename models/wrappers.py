...
class TrainingWrapper(ABC):
    ...
    @abstractmethod
    def train_on_fold(self, training_loader, validation_loader) -> object:
        """
...
class BenchmarkWrapper(ABC):
    ...
    @abstractmethod
    def benchmark(self, test_loader) -> object:
        """
...
class VisualizationWrapper(ABC):
    ...
    @abstractmethod
    def get_trajectory_predictions(self, data_tensor, total_segments) -> object:
        """
