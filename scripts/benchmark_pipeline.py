...
if __name__ == "__main__":
    ...
    models_config = {
        "weibull_dropout0": {
            ...
            "params": {
                "name": "biltsm_1l_64e_16bs_3fel_time_do0",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.15,
                "dropout_1d": False,
        ...
        "weibull_dropout15": {
            "model_class": RegressorTrainingWrapper,
            "params": {
                "name": "biltsm_1l_64e_16bs_3fel_time_do15",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.15,
                "embed_dim": 64,
        ...
        "weibull_dropout3": {
            "model_class": RegressorTrainingWrapper,
            "params": {
                "name": "biltsm_1l_64e_16bs_3fel_time_do3",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.3,
                "embed_dim": 64,
        ...
        "weibull_5fel": {
            "model_class": RegressorTrainingWrapper,
            "params": {
                "name": "biltsm_1l_64e_16bs_5fel_time_do3",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.3,
                "embed_dim": 64,
        ...
        "weibull_5fel_droupout15": {
            "model_class": RegressorTrainingWrapper,
            "params": {
                "name": "biltsm_1l_64e_16bs_5fel_time_do15",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.15,
                "embed_dim": 64,
        ...
        "gaussian_dropout15": {
            "model_class": RegressorTrainingWrapper,
            "params": {
                "name": "biltsm_1l_64e_16bs_3fel_time_do15_gaussian",
                "model_type": "bilstm",
                "bilstm_layers": 1,
                "dropout": 0.15,
                "embed_dim": 64,
    ...
    for model_name, config in models_config.items():
        ...
        if ckpt_path:
            ...
            raise FileNotFoundError(f"No checkpoint found for {model_name} with pattern {config['params']['name']}")
